...
SECRET_KEY = 'django-insecure-8wk_pxl7#e$qs-tm9mr$ux8=3t^1hpgxr$74z23#_ua_sdiz5)'
...
WSGI_APPLICATION = 'Tresinfra.wsgi.application'
...
EMAIL_HOST_PASSWORD = "ccnx ilmz sltt piwn"
...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "TRENSINFRA",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "TRENSINFRA",
    ...
    "welcome_sign": "Welcome to Trensifra Admin!",

    # Copyright on the footer
    "copyright": "Ngoga Innocent Patrick",
}